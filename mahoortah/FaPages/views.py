...
from pages.models import article,product,ProImage,Type,Project
...
def products(request):
    ...
    return render(request,'fa/products.html',{
...
def articles(request):
    ...
    return render(request,'fa/articles.html',{
        "list":list,
...
def seearticle(request,article_id):
    ...
    return render(request,'fa/seearticle.html',{
        "art":art,
...
def searching(request:HttpRequest):
    ...
    return render(request,'fa/searching.html',{
...
def aboutUs(request):
    return render(request,"fa/aboutus.html",{
        
    })


def contact(request):
    return render(request,"fa/contact.html",{}) 
...
def seeproduct(request,product_id):
    ...
    return render(request,'fa/seeproduct.html',{
        "thepro":thepro,
        "images":images,
        "similars":similars,
    })
...
def getarticle(request:HttpRequest,id):
    ...
    return render(request,"fa/getarticle.html",{
        "article":thearticle,
    })
...
def allprojects(request):
    ...
    return render(request,"fa/allprojects.html",{
        "projects":projects
    }) 
